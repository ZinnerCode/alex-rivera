...
const title = "Alex Rivera — Software Engineer | Automation, AI & Flutter";
const description =
  "Software engineer building intelligent software for engineering, automation and modern cross-platform applications with Flutter, AI and the cloud.";
    ...
    <main className="relative">
      ...
      <footer className="border-t border-border py-10 text-center text-sm text-muted-foreground">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-foreground/90">Software Product Development Engineer</p>
